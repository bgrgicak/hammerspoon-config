...
obj._window_state_name_to_rect = {
   ...
   left_third     = {0.00,0.00,0.3333333333,1.00},
   middle_third_h = {0.3333333333,0.00,0.3333333333,1.00},
   right_third    = {0.6666666667,0.00,0.3333333333,1.00},
   top_third      = {0.00,0.00,1.00,0.3333333333},
   middle_third_v = {0.00,0.3333333333,1.00,0.3333333333},
   bottom_third   = {0.00,0.6666666667,1.00,0.3333333333},

   left_two_third = {0.00,0.00,0.6666666667,1.00},
   right_two_third= {0.3333333333,0.00,1.00,1.00},

   left_two_forth = {0.00,0.00,0.25,1.00},
   right_two_forth= {0.75,0.00,1.00,1.00},
...
--   (example below)
obj._window_moves = {
   left_half = {"left_half", left_half = "left_two_third", left_two_third = "left_third", left_third="left_two_forth"},
   ...
   right_half = {"right_half", right_half = "right_two_third", right_two_third = "right_third", right_third="right_two_forth"},
